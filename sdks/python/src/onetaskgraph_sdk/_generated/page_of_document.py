...
class Page(BaseModel):
    items: Annotated[
        list[Document],
        Field(description="This page's items, in the source's stable order."),
    ]
    next: Annotated[
        Cursor | None,
        Field(description="The cursor for the next page, or `None` when the walk is exhausted."),
    ] = None
