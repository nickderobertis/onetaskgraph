...
#   schema root: QueryResponseOfQualifiedDocument
...
class QualifiedDocument(BaseModel):
    id: Annotated[
        GlobalId,
        Field(description="`<source>:<native>`, the form a user types back at the command line."),
    ]
    item: Annotated[Document, Field(description="The item as its source reported it, unchanged.")]
