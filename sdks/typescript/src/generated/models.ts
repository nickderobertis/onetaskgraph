...
export const SCHEMA_BUNDLE_VERSION = 20 as const;
 ...
 */
filter_by_priority?: ("native" | "unsupported")
/**
...
export namespace GeneratedComment {
/**
...
export type Comment = GeneratedComment.Comment;
export namespace GeneratedCommentList {
/**
...
export type CommentList = GeneratedCommentList.CommentList;
 ...
 */
export type GlobalId = string
export type Delivered1 = ({
/**
 * The category it read.
 */
from: ("draft" | "backlog" | "todo" | "queued" | "in-progress" | "done" | "cancelled" | "unknown")
outcome: "written"
/**
 * The category written.
 */
to: ("draft" | "backlog" | "todo" | "queued" | "in-progress" | "done" | "cancelled" | "unknown")
[k: string]: any
} | {
/**
 * The category it read.
...
export namespace GeneratedDeletedComment {
/**
...
export type DeletedComment = GeneratedDeletedComment.DeletedComment;
export namespace GeneratedDelivered {
/**
 * What keeping one delivered task in step with one deliverer came to.
 */
export type Delivered = ({
...
export type Delivered = GeneratedDelivered.Delivered;
export namespace GeneratedDeliveryOutcome {
/**
...
export type DeliveryOutcome = GeneratedDeliveryOutcome.DeliveryOutcome;
...
export type Document = GeneratedDocument.Document;
...
export type DocumentQuery = GeneratedDocumentQuery.DocumentQuery;
...
export namespace GeneratedFailure {
/**
 * The name a configuration document gives one configured source.
 */
export type SourceName = string
...
export type Failure = GeneratedFailure.Failure;
export namespace GeneratedFailureClass {
/**
 ...
 */
export type FailureClass = ("refused" | "transient")

}
export type FailureClass = GeneratedFailureClass.FailureClass;
export namespace GeneratedFailureDocument {
/**
 * The name a configuration document gives one configured source.
 */
export type SourceName = string
 ...
 */
color: ("GRAY" | "BLUE" | "GREEN" | "YELLOW" | "PURPLE" | "RED" | "ORANGE" | "PINK")
/**
...
export type FieldsReport = GeneratedFieldsReport.FieldsReport;
...
export type Location = GeneratedLocation.Location;
export namespace GeneratedMetadataSet {
/**
 * Where an entity is, in the one form a consumer can act on without knowing the backend.
 *
 * Externally tagged with exactly two variants, so the JSON is `{"url": "https://…"}` or
...
export type NewComment = GeneratedNewComment.NewComment;
...
export namespace GeneratedPageOfComment {
/**
 ...
 */
export interface PageOfComment {
/**
...
export type PageOfComment = GeneratedPageOfComment.PageOfComment;
 ...
 * One page of results, and where to pick up.
 */
export interface PageOfDocument {
/**
 * This page's items, in the source's stable order.
 */
items: Document[]
...
export type PageOfDocument = GeneratedPageOfDocument.PageOfDocument;
 ...
 */
category: ("draft" | "backlog" | "todo" | "queued" | "in-progress" | "done" | "cancelled" | "unknown")
/**
 ...
 */
export type Predicate = ("label" | "status" | "priority" | "search-title" | "search-content" | "project" | "document" | "reverse-dependencies")

}
export type Predicate = GeneratedPredicate.Predicate;
export namespace GeneratedPriority {
/**
...
export type Priority = GeneratedPriority.Priority;
 ...
 */
export interface QualifiedDocument {
/**
...
export type QualifiedDocument = GeneratedQualifiedDocument.QualifiedDocument;
 ...
 */
export interface QueryResponseOfQualifiedDocument {
/**
...
export type QueryResponseOfQualifiedDocument = GeneratedQueryResponseOfQualifiedDocument.QueryResponseOfQualifiedDocument;
...
export namespace GeneratedSourceName {
/**
 * The name a configuration document gives one configured source.
 */
export type SourceName = string
...
export type SourceName = GeneratedSourceName.SourceName;
...
export namespace GeneratedStatusOptionsReport {
/**
 * The plan and verified outcome of reconciling configured Status options.
 */
export interface StatusOptionsReport {
/**
 ...
 * What the requested operation did.
 */
outcome: ("planned" | "unchanged" | "applied")
/**
 * The configured source name.
 */
source: string
...
export type StatusOptionsReport = GeneratedStatusOptionsReport.StatusOptionsReport;
...
export namespace GeneratedTaskContentSet {
/**
 * What `task content set` answers with.
 */
export interface TaskContentSet {
/**
...
export type TaskContentSet = GeneratedTaskContentSet.TaskContentSet;
export namespace GeneratedTaskDetail {
/**
 * One task named by another task's [`Task::delivers`] or [`Task::delivered_by`].
 *
 * A string with one of two spellings, decided the way a [`DependencyEndpoint`] decides it:
...
export type TaskDetail = GeneratedTaskDetail.TaskDetail;
export namespace GeneratedTaskPrioritySet {
/**
 * What `task priority set` answers with.
 */
export interface TaskPrioritySet {
/**
...
export type TaskPrioritySet = GeneratedTaskPrioritySet.TaskPrioritySet;
...
export namespace GeneratedTaskRef {
/**
 * One task named by another task's [`Task::delivers`] or [`Task::delivered_by`].
 *
 * A string with one of two spellings, decided the way a [`DependencyEndpoint`] decides it:
...
export type TaskRef = GeneratedTaskRef.TaskRef;
export namespace GeneratedTaskStatusSet {
/**
 * What keeping one delivered task in step with one deliverer came to.
 */
export type Delivered = ({
...
export type TaskStatusSet = GeneratedTaskStatusSet.TaskStatusSet;
