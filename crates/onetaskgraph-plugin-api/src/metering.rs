...
/// counted is a measurement, while a modelled figure is the source's lower bound rather
/// than a measurement. A caller adding readings up has to keep the two apart to say which
/// a total is.
...
pub struct Metered {
    ...
    #[serde(default)]
    pub measured: u64,
    /// The lower bound this source models rather than measures.
    #[serde(default)]
    pub modelled: u64,
}
