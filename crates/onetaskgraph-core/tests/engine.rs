...
/// reader meets that.
/// The exact schema bundle published as version 16.
const SIXTEENTH_BUNDLE_SHAPE: [(&str, u64); 73] = [
    ...
    ("PageOfProject", 0x1af3a11f0379afef),
    ("PageOfTask", 0xb72c77f505a1d9c0),
    ...
    ("QualifiedProject", 0x561c0a31b7954e4d),
    ("QualifiedTask", 0x302cc67cf41cee90),
    ...
    ("QueryResponseOfQualifiedProject", 0x30def1c3cd12c864),
    ("QueryResponseOfQualifiedTask", 0x682c03f42c11b7d1),
    ("QueryResponseOfSearchHit", 0x9356004a4fab97aa),
    ("Repository", 0x98147ade92ced0f0),
    ("ResolvedCredential", 0x14a23b081a4e8d10),
    ("SearchHit", 0xb8ca944f970f92ec),
    ...
    ("Status", 0x9aeea7ad21e23334),
    ("StatusCategory", 0xeb567f8510446170),
    ("StatusOptionsReport", 0x02888a6905d1acd0),
    ("Task", 0x7d407c1ddcefcfb6),
...
/// The exact schema bundle published as version 17.
const SEVENTEENTH_BUNDLE_SHAPE: [(&str, u64); 74] = [
    ("Capabilities", 0xd878f8de45b30af0),
    ("Comment", 0xfc9fab5a2266887e),
    ("CommentList", 0xcd30d5deff29948d),
    ("CopyAction", 0x92821be0daa46894),
    ...
    ("SourceListing", 0x0d6f0a9b23705c87),
    ("SourceListings", 0x08a1adfdfeafaa8c),
    ("SourceName", 0x369c7453415b4c0d),
    ("SourcePlan", 0xd0c5548abc7d7223),
    ("Status", 0x9aeea7ad21e23334),
    ("StatusCategory", 0xeb567f8510446170),
    ("StatusOptionsReport", 0x0a5a8c013705e961),
    ("Task", 0x7d407c1ddcefcfb6),
    ("TaskDetail", 0xad3a71cf45fae03f),
    ("TaskQuery", 0x2d26e14d71c36263),
    ("TaskRef", 0xad8ce2508e0797c7),
...
/// The exact schema bundle published as version 19: version 18's document with `Task`
/// gaining the optional `key` its backend shows people beside the native `id`.
const NINETEENTH_BUNDLE_SHAPE: [(&str, u64); 73] = [
    ("Capabilities", 0xd878f8de45b30af0),
    ("Comment", 0xfc9fab5a2266887e),
    ("CommentList", 0xcd30d5deff29948d),
    ("CopyAction", 0x92821be0daa46894),
    ...
    ("QualifiedLabel", 0x7ac91fcfd8f41e30),
    ("QualifiedProject", 0x561c0a31b7954e4d),
    ("QualifiedTask", 0x398c6a543a105702),
    ("QueryPlan", 0x5cd046eed149f89b),
    ("QueryResponseOfQualifiedDocument", 0x1d9b28a5b989e218),
    ("QueryResponseOfQualifiedEdge", 0x9338c43bad99c95b),
    ("QueryResponseOfQualifiedLabel", 0xb94991dc4cfafb1b),
    ("QueryResponseOfQualifiedProject", 0x30def1c3cd12c864),
    ("QueryResponseOfQualifiedTask", 0x952cb47c61670e03),
    ("QueryResponseOfSearchHit", 0x110618efe511d260),
    ("Repository", 0x98147ade92ced0f0),
    ("ResolvedCredential", 0x14a23b081a4e8d10),
    ("SearchHit", 0xb6fc0013e9d6e456),
    ("SearchKind", 0xc4d2cd105ad4b849),
    ("SecretsReport", 0x245d50b08721b73d),
    ("Setting", 0xf593f9ae902cba68),
    ("SourceError", 0x33872c91770f86da),
    ...
    ("Status", 0x9aeea7ad21e23334),
    ("StatusCategory", 0xeb567f8510446170),
    ("Task", 0x651b105533226d08),
    ("TaskDetail", 0x87127240eff45c49),
    ("TaskQuery", 0x2d26e14d71c36263),
    ("TaskRef", 0xad8ce2508e0797c7),
    ("TaskStatusSet", 0xbe06dc239bf5eeb0),
    ("TextFields", 0x7240bd05f9beff93),
...
/// The exact schema bundle published as version 18.
const EIGHTEENTH_BUNDLE_SHAPE: [(&str, u64); 73] = [
    ("Capabilities", 0xd878f8de45b30af0),
    ("Comment", 0xfc9fab5a2266887e),
    ("CommentList", 0xcd30d5deff29948d),
    ("CopyAction", 0x92821be0daa46894),
...
/// The exact schema bundle published as version 20: version 19's document with `Task`
/// gaining its `priority`, `Capabilities` the two priority declarations, `TaskQuery` its
/// priority filter, `Predicate` the `priority` predicate, and three new roots — `Priority`,
/// and what `task priority set` and `task content set` answer with.
const TWENTIETH_BUNDLE_SHAPE: [(&str, u64); 76] = [
    ("Capabilities", 0x2dd1291cc0435282),
    ("Comment", 0xfc9fab5a2266887e),
    ("CommentList", 0xcd30d5deff29948d),
    ("CopyAction", 0x92821be0daa46894),
    ("CopyOutcome", 0xefcf23cfbd5dde3b),
    ...
    ("PageOfLabel", 0xd6110ddeeaaa78e8),
    ("PageOfProject", 0x1af3a11f0379afef),
    ("PageOfTask", 0x717f39314b6520f4),
    ("PageRequest", 0x6c7be3975028b78c),
    ("PageToken", 0xc685683af2c78c39),
    ("Predicate", 0xef8e83291ff74011),
    ...
    ("QualifiedLabel", 0x7ac91fcfd8f41e30),
    ("QualifiedProject", 0x561c0a31b7954e4d),
    ("QualifiedTask", 0x1ff3b850773a1718),
    ("QueryPlan", 0x87d3d0976189c4bc),
    ("QueryResponseOfQualifiedDocument", 0xa1f989eb03eff231),
    ("QueryResponseOfQualifiedEdge", 0xc79bd819668cbd60),
    ("QueryResponseOfQualifiedLabel", 0x9ae89fede48d7f90),
    ...
    ("SourceError", 0x33872c91770f86da),
    ("SourceFailure", 0xb30fd488e61b4def),
    ("SourceListing", 0x425c1c63bae2526d),
    ("SourceListings", 0x570ec0bdc753cabe),
    ("SourceName", 0x369c7453415b4c0d),
    ("SourcePlan", 0x830edd1b4418017c),
    ("Status", 0x9aeea7ad21e23334),
    ("StatusCategory", 0xeb567f8510446170),
    ("Task", 0x1833e6402c9cd452),
    ("TaskContentSet", 0x7f9ab07c60d6f804),
    ("TaskDetail", 0x4cfecd5bb54a6506),
...
const PUBLISHED_BUNDLES: &[(u32, Published)] = &[
    ...
    (14, Published::Shapes(&FOURTEENTH_BUNDLE_SHAPE)),
    (15, Published::Shapes(&FIFTEENTH_BUNDLE_SHAPE)),
    (16, Published::Shapes(&SIXTEENTH_BUNDLE_SHAPE)),
    (17, Published::Shapes(&SEVENTEENTH_BUNDLE_SHAPE)),
    (18, Published::Shapes(&EIGHTEENTH_BUNDLE_SHAPE)),
    (19, Published::Shapes(&NINETEENTH_BUNDLE_SHAPE)),
    (20, Published::Shapes(&TWENTIETH_BUNDLE_SHAPE)),
];
...
const FOURTEENTH_BUNDLE_SHAPE: [(&str, u64); 71] = [
    ("Capabilities", 0xd878f8de45b30af0),
    ("Comment", 0xfc9fab5a2266887e),
    ("CommentList", 0xcd30d5deff29948d),
    ("CopyAction", 0x92821be0daa46894),
...
/// The shape version 15 of the bundle publishes.
///
/// `MetadataSet`, what the three `metadata set` verbs answer with. Every other root is exactly
/// what version 14 published.
const FIFTEENTH_BUNDLE_SHAPE: [(&str, u64); 72] = [
    ("Capabilities", 0xd878f8de45b30af0),
    ("Comment", 0xfc9fab5a2266887e),
    ("CommentList", 0xcd30d5deff29948d),
    ("CopyAction", 0x92821be0daa46894),
