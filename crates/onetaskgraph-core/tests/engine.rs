...
/// Version 10 makes a copy's reference figures reachable: a document copy points the
/// references its content holds at the destination's own records and says how many it
/// rewrote, how many it left unresolved and how many of those were ambiguous, and a
/// consumer acts on that last figure.
const TENTH_BUNDLE_ROOTS: [&str; 59] = [
    "Task",
    "Project",
    "Document",
    "Location",
