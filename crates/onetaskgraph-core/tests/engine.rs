...
const NINETEENTH_BUNDLE_SHAPE: [(&str, u64); 73] = [
    ...
    ("QualifiedLabel", 0x7ac91fcfd8f41e30),
    ("QualifiedProject", 0x561c0a31b7954e4d),
    ("QualifiedTask", 0x2148a5c9a1095272),
    ("QueryPlan", 0x5cd046eed149f89b),
    ("QueryResponseOfQualifiedDocument", 0x1d9b28a5b989e218),
    ("QueryResponseOfQualifiedEdge", 0x9338c43bad99c95b),
    ("QueryResponseOfQualifiedLabel", 0xb94991dc4cfafb1b),
    ("QueryResponseOfQualifiedProject", 0x30def1c3cd12c864),
    ("QueryResponseOfQualifiedTask", 0x40243037abd19593),
    ("QueryResponseOfSearchHit", 0xc220e1b3a2c06434),
    ("Repository", 0x98147ade92ced0f0),
    ("ResolvedCredential", 0x14a23b081a4e8d10),
    ("SearchHit", 0x1cc63895c891c2c6),
    ("SearchKind", 0xc4d2cd105ad4b849),
    ("SecretsReport", 0x245d50b08721b73d),
    ("Setting", 0xf593f9ae902cba68),
    ("SourceError", 0x33872c91770f86da),
    ...
    ("Status", 0x9aeea7ad21e23334),
    ("StatusCategory", 0xeb567f8510446170),
    ("Task", 0x02023c5809a48656),
    ("TaskDetail", 0xa32a3f64b375a07d),
    ("TaskQuery", 0x2d26e14d71c36263),
    ("TaskRef", 0xad8ce2508e0797c7),
    ("TaskStatusSet", 0xbe06dc239bf5eeb0),
    ("TextFields", 0x7240bd05f9beff93),
