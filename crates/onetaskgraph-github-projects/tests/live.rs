...
#[tokio::test]
// llmlint: ignore[live_tier_compiles_and_requires_credential] This lane skips without a credential by decision (AGENTS.md); `ONETASKGRAPH_LIVE_REQUIRED=1` is what demands one.
