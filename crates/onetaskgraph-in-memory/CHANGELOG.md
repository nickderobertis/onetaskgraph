...
## [0.2.32](https://github.com/nickderobertis/onetaskgraph/compare/onetaskgraph-in-memory-v0.2.31...onetaskgraph-in-memory-v0.2.32) - 2026-09-15
...
## [0.2.31](https://github.com/nickderobertis/onetaskgraph/compare/onetaskgraph-in-memory-v0.2.30...onetaskgraph-in-memory-v0.2.31) - 2026-09-14
...
## [0.2.22](https://github.com/nickderobertis/onetaskgraph/compare/onetaskgraph-in-memory-v0.2.21...onetaskgraph-in-memory-v0.2.22) - 2026-09-04
...
## [0.2.15](https://github.com/nickderobertis/onetaskgraph/compare/onetaskgraph-in-memory-v0.2.14...onetaskgraph-in-memory-v0.2.15) - 2026-09-01

### Added

- *(in-memory)* serve documents and both location shapes ([#138](https://github.com/nickderobertis/onetaskgraph/pull/138))

## [0.2.14](https://github.com/nickderobertis/onetaskgraph/compare/onetaskgraph-in-memory-v0.2.13...onetaskgraph-in-memory-v0.2.14) - 2026-09-01

### Added

- *(plugin-api)* give the source contract documents and locations ([#114](https://github.com/nickderobertis/onetaskgraph/pull/114))

## [0.2.13](https://github.com/nickderobertis/onetaskgraph/compare/onetaskgraph-in-memory-v0.2.12...onetaskgraph-in-memory-v0.2.13) - 2026-08-30
...
## [0.2.12](https://github.com/nickderobertis/onetaskgraph/compare/onetaskgraph-in-memory-v0.2.11...onetaskgraph-in-memory-v0.2.12) - 2026-08-29
...
## [0.2.9](https://github.com/nickderobertis/onetaskgraph/compare/onetaskgraph-in-memory-v0.2.8...onetaskgraph-in-memory-v0.2.9) - 2026-08-28
...
## [0.2.0](https://github.com/nickderobertis/onetaskgraph/compare/onetaskgraph-in-memory-v0.1.0...onetaskgraph-in-memory-v0.2.0) - 2026-08-26
...
## [0.1.0](https://github.com/nickderobertis/onetaskgraph/releases/tag/onetaskgraph-in-memory-v0.1.0) - 2026-08-25
