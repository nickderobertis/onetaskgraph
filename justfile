...
schema:
    @cargo run --quiet -p onetaskgraph --bin onetaskgraph -- schema || { echo "next: run 'cargo build -p onetaskgraph --bin onetaskgraph' and fix the reported build failure"; exit 1; }
